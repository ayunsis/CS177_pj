...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{images/top20_heatmap.png}
    \includegraphics[width=0.35\textwidth]{images/gap_histogram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{images/gap_boxplot.png}
    \includegraphics[width=0.4\textwidth]{images/gap_violinplot.png}
    \caption{Boxplot (top) and violin plot (bottom) of prediction gaps for AF3 structures.}
...
The top 10 error complexes and their relative protein structures, Chai-1 overall confidence scores
are demonstrated in table~\ref{tab:top10_error}.
\begin{table}[H]
\centering
\caption{Top 10 complexes with largest prediction gaps.`heter' for heterogeneous, `iso' for isomorphic.}
...
Statistics of those complexes shows no significance in protein structures,
suggesting that AF3's performance is not originated from incapability of 
handling certain particular complex structures. On the other hand, the
overall high aggregate scores raises concerns about the reliability of
AF3's confidence scores under the context of PLA prediction. 
