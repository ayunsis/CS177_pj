...
plt.title('Difference Between Core2016 and SFCNN Gaps Across Entries', fontsize=17, fontweight='bold')
plt.xlabel('Entry Index', fontsize=13)
...
plt.title('Top 20 Entries with Largest Core2016 Gaps\nComparison with SFCNN and Gap Difference', fontsize=16, fontweight='bold')
...
plt.title('Distribution of Absolute Gaps\n(Core2016 vs SFCNN)', fontsize=16, fontweight='bold')
...
plt.title('Boxplot of Absolute Gaps', fontsize=15, fontweight='bold')
...
plt.title('Violin Plot of Absolute Gaps', fontsize=15, fontweight='bold')
plt.ylabel('Absolute Gap', fontsize=13)
plt.xticks(fontsize=12)
plt.yticks(fontsize=11)
plt.grid(True, linestyle=':', alpha=0.8)
